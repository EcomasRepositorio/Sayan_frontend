      ...
      <div className="p-5 bg-gradient-to-br from-primaryblue to-primaryceleste">
        ...
        <div className="team-area">
            ...
            <figure className="boxG">
                 ...
                 <div className="figuree">
                  ...
                  <div className="lg:text-5xl md:text-4xl text-4xl font-bebas-neue mt-4">INGENIERÍA CIVIL</div>
            ...
            <figure className="boxG">
                <Link href="/graduate">
                <div className="figuree">
                    <div className="lg:text-5xl md:text-4xl text-4xl font-bebas-neue mt-4">INGENIERÍA AMBIENTAL</div>
                    <p></p>
                    <p className="socials">
                        <i className="fa fa-facebook"></i>
                        <i className="fa fa-twitter"></i>
            ...
            <figure className="boxG">
                <Link href="/graduate">
                <div className="figuree">
                    <div className="lg:text-5xl md:text-4xl text-4xl  font-bebas-neue mt-4">INGENIERÍA AGRÓNOMA</div>
                    <p></p>
                    <p className="socials">
                        <i className="fa fa-facebook"></i>
                        <i className="fa fa-twitter"></i>
        ...
        <div className="team-area">
            ...
            <figure className="boxG">
                <Link href="/graduate">
                <div className="figuree">
                    <div className="lg:text-5xl md:text-4xl text-4xl  font-bebas-neue mt-4">INGENIERÍA AlIMENTARIA</div>
                    <p></p>
                    <p className="socials">
                        <i className="fa fa-facebook"></i>
                        <i className="fa fa-twitter"></i>
            ...
            <figure className="boxG">
                <Link href="/graduate">
                <div className="figuree">
                    <div className="lg:text-5xl md:text-4xl text-4xl font-bebas-neue mt-4">PROFESIONES EN GENERAL</div>
                    <p></p>
                    <p className="socials">
                        <i className="fa fa-facebook"></i>
                        <i className="fa fa-twitter"></i>
