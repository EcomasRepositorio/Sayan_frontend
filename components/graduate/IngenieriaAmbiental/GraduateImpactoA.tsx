...
import { coursesEstudioAmbiental } from "@/components/utils/courses/course";
...
const GraduateTecnico = () => {
  ...
  const handleClick = () => {
    const newWindow = window.open(
      "/brochure/Brochure - ESTUDIO_IMPACTO_AMBIENTAL.pdf"
    );
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement("a");
    link.href = "/brochure/Brochure - ESTUDIO_IMPACTO_AMBIENTAL.pdf";
    link.download = "Brochure - ESTUDIO_IMPACTO_AMBIENTAL.pdf";
    link.click();
  };
      ...
      <div className="md:px-20 flex flex-col sm:flex-row justify-center mb-16 ">
        <div className="sm:w-96 mb-4 sm:mb-0">
          <Image
            ...
            src="/graduate/estudio-de-impacto-ambiental.webp"
            alt="icon"
            width={1200}
            height={1200}
          />
        ...
        <div className="p-5 sm:w-1/2 md:px-20 sm:px-5 lg:mt-8 ">
          ...
          <div className="mb-4">
            <p className="text-sm font-semibold text-gray-600">
              El Estudio de Impacto Ambiental (EIA) es una herramienta crucial
              en la planificación y ejecución de proyectos que tienen el
              potencial de afectar el entorno natural y humano. Su objetivo
              principal es evaluar y prever los posibles efectos adversos que
              una actividad o proyecto puede tener sobre el medio ambiente y la
              sociedad antes de que se lleve a cabo. Es fundamental para la toma
              de decisiones informadas y responsables que minimicen los impactos
              negativos y maximicen los beneficios
            </p>
          </div>
          <div className="grid lg:grid-cols-2 grid-cols-1 text-primaryblue text-sm mb-4">
            <div className="flex items-center mb-2">
              <GoClockFill className="text-lg" />
              <p className="font-bold ml-1">Inicio 10 de Marzo</p>
            </div>
          ...
          <div className="">
            <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-2">
              ...
              <div>
                ...
                >
                  <div className="cursor-pointer items-center text-xs uppercase inline-flex">
          ...
          {isAccordionOpen1 && (
            ...
            >
              <div className="text-sm font-sans font-semibold">
                <ul className="">
                  {coursesEstudioAmbiental.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
                      animate={{
