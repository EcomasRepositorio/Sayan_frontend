...
import { coursesFertirriego } from "@/components/utils/courses/course";
...
const GraduateTecnico = () => {
  ...
  const handleClick = () => {
    const newWindow = window.open(
      "/brochure/BROCHURE DE RIEGO Y FERTIRRIEGO.pdf"
    );
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement("a");
    link.href = "/brochure/BROCHURE DE RIEGO Y FERTIRRIEGO.pdf";
    link.download = "BROCHURE DE RIEGO Y FERTIRRIEGO.pdf";
    link.click();
  };
      ...
      <div className="md:px-20 flex flex-col sm:flex-row justify-center mb-16 ">
        <div className="sm:w-96 mb-4 sm:mb-0">
          <Image
            ...
            src="/graduate/riego-y-fertirriego.webp"
            alt="icon"
            width={1200}
            height={1200}
          />
        ...
        <div className="p-5 sm:w-1/2 md:px-20 sm:px-5 lg:mt-8 ">
          ...
          <div className="mb-4">
            <p className="text-sm font-semibold text-gray-600">
              La creciente demanda en el uso del recurso hídrico por parte de la
              actividad agrícola, los impactos del cambio climático, la menor
              disponibilidad de mano de obra y los altos costos de energía,
              hacen urgente la actualización y el desarrollo de competencias
              profesionales relacionadas con el diseño e implementación de
              sistemas de riego y de la fertirrigación con la finalidad de
              obtener una mejor producción agrícola.
            </p>
          </div>
          ...
          {isAccordionOpen1 && (
            ...
            >
              <div className="text-sm font-sans font-semibold">
                <ul className="">
                  {coursesFertirriego.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
                      animate={{
