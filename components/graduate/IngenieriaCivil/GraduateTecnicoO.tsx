...
const GraduateTecnico = () => {
  ...
  const handleClick = () => {
    const newWindow = window.open(
      "/brochure/BROCHURE DE ASISTENTE TÉCNICO EN OBRAS.pdf"
    );
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement("a");
    link.href = "/brochure/BROCHURE DE ASISTENTE TÉCNICO EN OBRAS.pdf";
    link.download = "ASISTENTE_TECNICO_EN_OBRAS.pdf";
    link.click();
  };
        ...
        <div className="p-5 sm:w-1/2 md:px-20 sm:px-5 lg:mt-8 ">
          ...
          <div className="mb-4">
            <p className="text-sm font-semibold text-gray-600">
              Los Asistentes técnicos de obra se encargan de asegurar el buen
              funcionamiento de una obra o proyectos realizando labores de
              asistente, tales como archivar, planificar y coordinar las
              actividades de una obra, además de redactar los reportes
              correspondientes. Dirigir técnica y administrativa, la ejecución
              de la obra.
            </p>
          </div>
          ...
          <div className="">
            <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-2">
              ...
              <div className="w-full">
                <a
                  onClick={handleClick}
                  className="border-2 border-primaryceleste w-full cursor-pointer flex items-center justify-center mb- text-gray-600 font-bold rounded-xl p-2 hover:scale-105 duration-300"
