...
import { coursesAsistenteViales   } from "@/components/utils/courses/course";
...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochure/ASISTENTE TECNICO EN OBRAS VIALES.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochure/ASISTENTE TECNICO EN OBRAS VIALES.pdf';
    link.download = 'ASISTENTE_TECNICO_EN_OBRAS_VIALES.pdf';
    link.click();
  };
    ...
    <div id="irrigation" className="">
       <div className="md:px-20 flex flex-col sm:flex-row justify-center mb-16 ">
          ...
          <div className="p-5 sm:w-1/2 md:px-20 sm:px-5 lg:mt-8 ">
            ...
            ASISTENTE TÉCNICO EN OBRAS VIALES
            </div>
            <div className="mb-4">
            ...
            {isAccordionOpen1 && (
              <motion.div
                ...
                <div className="text-sm font-sans font-semibold">
                  <ul className="">
                  {coursesAsistenteViales.map((item , index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
...
export default GraduateTecnicoOV;