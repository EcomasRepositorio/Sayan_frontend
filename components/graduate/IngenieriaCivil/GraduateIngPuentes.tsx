...
import { coursesIngenieriaPuentes } from "@/components/utils/courses/course";
...
const GraduatePuentes = () => {
  ...
  const handleClick = () => {
    const newWindow = window.open(
      "/brochure/BROCHURE DE INGENIERÍA DE PUENTES.pdf"
    );
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement("a");
    link.href = "/brochure/BROCHURE DE INGENIERÍA DE PUENTES.pdf";
    link.download = "BROCHURE_INGENIERÍA DE PUENTES.pdf";
    link.click();
  };
      ...
      <div className="md:px-20 flex flex-col sm:flex-row justify-center mb-16 ">
        <div className="sm:w-96 mb-4 sm:mb-0">
          <Image
            ...
            src="/graduate/ingenieria-de-puentes.webp"
            alt="icon"
            width={1200}
            height={1200}
          />
        ...
        <div className="p-5 sm:w-1/2 md:px-20 sm:px-5 lg:mt-8 ">
          ...
          <div className="mb-4">
            <p className="text-sm font-semibold text-gray-600">
              En el Diplomado en Ingeniería de Puentes aprenderás a analizar y
              diseñar estructuras de puentes usando los manuales y normativas
              vigentes para el diseño de puentes. Conocerás los diversos
              componentes de los puentes, y entenderás las disposiciones de
              diseño propias de puentes, así como el comportamiento sísmico de
              ellos.
            </p>
          </div>
          ...
          {isAccordionOpen1 && (
            ...
            >
              <div className="text-sm font-sans font-semibold">
                <ul className="">
                  {coursesIngenieriaPuentes.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
                      animate={{
...
export default GraduatePuentes;
