...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochure/BROCHURE DE INGENIERÍA DE PUENTES.pdf');
                ...
                <div>
                  ...
                  {showModal && (
                    <Modal open={showModal} onClose={() => setShowModal(false)}>
                      <Image src={imageUrl} width={400} height={420} alt="certificate_sayan" />
                    </Modal>
                  )}
                  </div>
                </div>
                ...
                <div className="text-sm font-sans font-semibold">
                  ...
                  {coursesIngenieriaPuentes.map((item , index) => (
                    <motion.li
                      ...
                      onClick={() => window.open(`https://wa.me/51978490739/?text=${encodeURIComponent(item.text)}`, '_blank')}>
