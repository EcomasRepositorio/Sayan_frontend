    ...
    <div id="Alimentary" className="">
       <div className="md:px-20 flex flex-col sm:flex-row justify-center lg:mt-8">
          ...
          <div className="sm:w-1/2 md:px-20 sm:px-5 lg:mt-8">
            <div className="text-primaryblue font-extrabold font-poppins lg:text-3xl text-2xl my-2 mb-2">
            ...
            <div className="">
              <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-2">
                ...
                <div>
                  <button
                    className="border-2 border-primarygreen w-full flex items-center justify-center mb-4 text-gray-600 font-bold rounded-xl p-2 hover:scale-105 duration-300"
