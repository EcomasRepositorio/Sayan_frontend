...
const GraduateTecnico = () => {
  ...
  const handleClick = () => {
    const newWindow = window.open(
      "/brochure/BROCHURE - INOCUIDAD ALIMENTARIA.pdf"
    );
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement("a");
    link.href = "/brochure/BROCHURE - INOCUIDAD ALIMENTARIA.pdf";
    link.download = "BROCHURE - INOCUIDAD ALIMENTARIA.pdf";
    link.click();
  };
        ...
        <div className="p-5 sm:w-1/2 md:px-20 sm:px-5 lg:mt-8 ">
          ...
          <div className="mb-4">
            <p className="text-sm font-semibold text-gray-600">
              La producción de alimentos es uno de los sectores más dinámicos e
              importantes de nuestro país. El desarrollo que viene
              experimentando las industrias de alimentos y los servicios de
              alimentación y afines requiere de una visión integrada y
              especializada que asegure la calidad, seguridad e inocuidad de los
              productos y los procesos. En consecuencia, los consumidores son
              cada vez más exigentes en relación a la calidad de los productos
              que adquieren.
            </p>
          </div>
