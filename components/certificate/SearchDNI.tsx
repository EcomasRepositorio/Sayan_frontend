  ...
  return (
    ...
    <div className="relative lg:mx-auto mr-4 ml-4">
        ...
        <input
          ...
          value={queryValue}
          />
        <button type="submit" className="botonCert absolute end-1.5 bottom-3 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-1.5">Buscar</button>
    </div>
  </form>
